...
MP_PRIVATE mp_err s_mp_mul_high_digs_fast(const mp_int *a,
  const mp_int *b,
  mp_int *c,
  int digs) MP_WUR;
...
MP_PRIVATE mp_err
s_mp_exptmod_fast(const mp_int *G, const mp_int *X, const mp_int *P, mp_int *Y, int redmode) MP_WUR;
MP_PRIVATE mp_err
s_mp_exptmod(const mp_int *G, const mp_int *X, const mp_int *P, mp_int *Y, int redmode) MP_WUR;
MP_PRIVATE mp_err s_mp_rand_platform(void *p, size_t n) MP_WUR;
MP_PRIVATE mp_err s_mp_prime_random_ex(mp_int *a,
  int t,
  int size,
  int flags,
...
MP_DEPRECATED(s_mp_exptmod_fast)
...
MP_DEPRECATED(s_mp_karatsuba_mul)
...
#define MP_GET_MAG(name, type)                                                                     \
	...
	{                                                                                              \
		unsigned i = MP_MIN((unsigned)a->used,                                                     \
