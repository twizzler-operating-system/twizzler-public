...
C_SOURCES+=$(addprefix arch/$(ARCH)/,init.c processor.c memory.c debug.c pit.c ioapic.c acpi.c madt.c idt.c entry.c vmx.c virtmem.c hpet.c thread.c rdrand.c object.c intel_iommu.c x2apic.c)
