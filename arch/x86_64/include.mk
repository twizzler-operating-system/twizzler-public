...
QEMU=qemu-system-x86_64 -cpu host,migratable=false,host-cache-info=true,host-phys-bits -machine q35 -m 1024 # -kernel #$(BUILDDIR)/kernel # -initrd $(BUILDDIR)/initrd.tar -cpu host
